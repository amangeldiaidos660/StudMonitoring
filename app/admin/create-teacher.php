...
include "../../path.php";
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create-teacher'])){
    $role = 1;
    ...
    if($login === '' || $email === '' || $passF === ''){
        ...
        if($existence['mail'] === $email){
            ...
            $id = insert('teachers', $user);
            $user = selectOne('teachers', ['id' => $id] );
            userAuth($user);
        }
    }
}else{
        ...
        <div class="right-panel">
            <div class="card-body">
                    ...
                    <h4>Оқытушыны тіркеу</h4>
                        ...
                        <button name="create-teacher" type="submit">Тіркеу</button>
                    </form>
            </div>
        </div>
    </div>
